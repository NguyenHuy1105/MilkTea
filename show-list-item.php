    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        categoryItems.forEach(function(item) {
            item.addEventListener('click', function() {
                ...
                } else if (categoryId === 'CT003') { // Ví dụ: Sinh Tố
                    loadContentAndDisplay('public/filter-page/sinhto.php');
                } else if (categoryId === 'CT004') { // Ví dụ: Bánh Kem
                    loadContentAndDisplay('public/filter-page/banhkem.php');
                } else if (categoryId === 'CT002') { // Ví dụ: Soda
                    loadContentAndDisplay('public/filter-page/soda.php');
                } else {
                    loadContentAndDisplay('public/filter-page/trasua.php'); // Xử lý mặc định cho trường hợp khác
                }
