        ...
        <div class="container-content-list-product">
            <div class="list-product-all-item">
                ...
                $sql = "SELECT products.*, product_sizes.product_price
                        ...
                        WHERE products.category_id IN (SELECT category_id FROM categorys WHERE category_name = 'Bánh Kem')";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "Không có sản phẩm Bánh Kem.";
                }
